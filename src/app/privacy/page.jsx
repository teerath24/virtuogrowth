      ...
      <section className="py-20 px-6 md:px-12 bg-slate-50 dark:bg-slate-800">
        <div className="max-w-4xl mx-auto text-slate-800 dark:text-slate-200">
          ...
          <p className="mb-6">
            ...
            trusted third-party tools (such as our CRM and email platforms)
            solely to deliver our services. All third parties are required to
            handle your data securely and in accordance with applicable law.
          </p>
