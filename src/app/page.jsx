    ...
    <main className="w-full">
      ...
      <section className="relative bg-slate-50 dark:bg-slate-800 transition-colors duration-300">
        <div className="absolute inset-0 z-0">
          {mounted ? (
            <Image
              src={isDark ? "/darkService.jpg" : "/lightService.jpg"}
            ...
            >
              <div className="relative flex-1 bg-[#004F7F] dark:bg-[#ECC600] rounded-lg p-8 md:p-10 shadow-xl overflow-hidden h-full">
                ...
                <button
                  ...
                  style={{
                    backgroundColor: mounted && isDark ? "#fff" : "#ECC600",
                    color: "#004F7F",
                  }}
                >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-lg max-w-3xl mx-auto">
              We&apos;re not a freelancer marketplace. We&apos;re your dedicated
              talent partner, committed to finding professionals who become true
