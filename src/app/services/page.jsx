...
export default function Services() {
  ...
  const handlePricingSelect = (planName) => {
    router.push(`/contact?service=Virtual Assistants&plan=${planName}`);
  };

  const handleWebProjectSelect = (serviceName) => {
    ...
    <main className="w-full">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[60vh] p-6 text-center transition-colors duration-300 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src={isDark ? "/blackHero.jpg" : "/whiteHero.jpg"}
      ...
      <section className="bg-slate-50 dark:bg-slate-800 py-24 px-6 transition-colors duration-300">
        <div className="max-w-6xl mx-auto text-center mb-16">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg max-w-3xl mx-auto">
            We don&apos;t just connect you with talent — we ensure they&apos;re
          ...
          {[
            {
              ...
              desc: "Every professional goes through our comprehensive screening process to ensure top-quality talent.",
              icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z",
            },
            {
              title: "Perfect Matching",
              desc: "We analyze your needs and match you with talent that fits your culture, industry, and requirements.",
              icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z",
            },
            {
              title: "Fast Onboarding",
              desc: "Get matched with qualified professionals within 48 hours and start working within a week.",
              icon: "M13 10V3L4 14h7v7l9-11h-7z",
            },
            {
              title: "Ongoing Support",
              desc: "Dedicated account management and continuous support to ensure smooth collaboration.",
              icon: "M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z",
            },
          ].map((item, i) => (
            <div
              key={i}
              className="bg-white dark:bg-slate-900 rounded-2xl p-8 text-center shadow-sm transition-shadow duration-300 group"
            >
          ...
          {[
            {
              ...
              description:
                "Share your requirements, budget, and project details through our simple intake form.",
            },
            {
              number: "2",
              title: "We Find the Match",
              description:
                "Our team reviews and selects the most qualified professionals matched to your criteria from our vetted talent pool to find your perfect match.",
            },
            {
              number: "3",
              title: "Meet & Approve",
              description:
                "Review profiles, interview candidates, and approve your preferred talent before starting.",
            },
            {
              number: "4",
              title: "Start Working",
              description:
                "Begin your project with full support from our team to ensure smooth collaboration.",
            },
          ].map((step) => (
      ...
      >
        ...
        <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
          <PricingCard
            ...
            onButtonClick={() => handlePricingSelect("Starter")}
          />
          <PricingCard
            badge="POPULAR"
            title="Part-Time"
            ...
            onClick={() => setSelectedPricing("Part-Time")}
            onButtonClick={() => handlePricingSelect("Part-Time")}
          />
          <PricingCard
            title="Full-Time"
            ...
            onClick={() => setSelectedPricing("Full-Time")}
            onButtonClick={() => handlePricingSelect("Full-Time")}
          />
          <PricingCard
            title="Enterprise"
            ...
            onButtonClick={() => handlePricingSelect("Enterprise")}
          />
        </div>
      </section>
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <WebProjectCard
            ...
            onClick={() => setSelectedWebProject("Landing Page")}
            onButtonClick={() => handleWebProjectSelect("Landing Page")}
          />
          <WebProjectCard
            badge="MOST POPULAR"
            ...
            onClick={() => setSelectedWebProject("Business Website")}
            onButtonClick={() => handleWebProjectSelect("Business Website")}
          />
          <WebProjectCard
            ...
            onClick={() => setSelectedWebProject("E-Commerce Store")}
            onButtonClick={() => handleWebProjectSelect("E-Commerce Store")}
          />
        </div>
...
const ViewPricingButton = ({ onClick, text }) => {
...
const PricingCard = ({
  ...
  return (
    <div
      ...
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
      className={`relative rounded-2xl p-8 transition-all duration-300 hover:shadow-xl group cursor-pointer ${isSelected ? "bg-[#004F7F] dark:bg-[#ECC600] text-white dark:text-[#004F7F] border-2 border-[#004F7F] dark:border-[#ECC600] transform scale-105" : "bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700"}`}
    >
      {badge && (
        <div className="absolute -top-3 left-1/2 -translate-x-1/2">
          <span className="bg-[#ECC600] dark:bg-[#004F7F] text-[#004F7F] dark:text-[#ECC600] text-xs font-bold px-4 py-1 rounded-full">
      ...
      <button
        ...
        className="relative w-full cursor-pointer py-3 rounded-full font-bold overflow-hidden transition-all duration-300 group-hover:scale-105"
      >
        <div
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="relative cursor-pointer w-full py-3 rounded-full font-bold overflow-hidden transition-all duration-300 group-hover:scale-105"
      >
        <div
          className={`absolute inset-0 ${isSelected ? "bg-white dark:bg-[#004F7F]" : "bg-[#004F7F] dark:bg-[#ECC600]"}`}
        ></div>
