      ...
      <section className="pt-32 pb-20 px-6 md:px-12">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-400 mb-8">
            We&apos;re revolutionizing how businesses access elite global
            talent.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-lg text-slate-700 dark:text-slate-300">
            <p>
              ...
              aren&apos;t equally distributed. Meanwhile, businesses struggle to
              find reliable, skilled talent that fits their specific needs.
            </p>
            <p>
              We set out to bridge this gap by creating a platform that
              doesn&apos;t just connect businesses with talent, but ensures
              perfect matches through rigorous vetting, cultural alignment, and
              ongoing support.
            </p>
            <p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-lg text-slate-700 dark:text-slate-300">
            ...
            <p>
              ...
              should have access to the best people, regardless of where
              they&apos;re located.
            </p>
          </div>
        </div>
      ...
      <section className="py-20 px-6 md:px-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-lg text-slate-700 dark:text-slate-300">
            ...
            <p>
              We&apos;re not just a marketplace—we&apos;re a partner invested in
              the success of every relationship we facilitate.
            </p>
          </div>
        </div>
      </section>
