  ...
  return (
    <main className="bg-white dark:bg-slate-900 pt-32 pb-20 px-6 md:px-12">
      <div className="max-w-4xl mx-auto text-slate-800 dark:text-slate-200">
        ...
        <p className="mb-6">
          By accessing or using VirtuoGrowth Partners' website or services, you
        ...
        <p className="mb-6">
          ...
          recruitment, vetting, and ongoing management of placed professionals.
        </p>
        ...
        <p className="mb-6">
          ...
          without written consent and payment of the applicable buyout fee. This
          restriction applies during the engagement and for 24 months following
          termination.
        </p>
        ...
        <p className="mb-6">
          ...
          consequential damages arising from use of our website or services. Our
          total liability shall not exceed the fees paid by the client for the
